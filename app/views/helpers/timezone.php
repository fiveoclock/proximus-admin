...
class TimeZoneHelper extends AppHelper { 
    ...
    var $timezones = array( 
    '' => 'Use the system time of the server',
    ...
    '+1:0' => '(GMT +1:00 hours) CET(Central Europe Time), Vienna, Copenhagen, Madrid, Paris', 
    ...
    '+8:0' => '(GMT +8:00 hours) Perth, Singapore, Hong Kong, Chongqing, Urumqi, Taipei', 
