...
<div class="logs form">
<?php echo $form->create(null, array('url' => '/logs/searchstring')); ?>
	<fieldset>
      <legend><?php __('View Logs');?></legend>
	<?php
      echo $form->input('locations');
      echo $form->input('searchstring',array('label'=>'Search pattern (part of User name or Real name)'));
	?>
...
<div class="related">
   ...
   <tr>
      ...
      <th><?php __('Generated by'); ?></th>
      <th><?php __('For User'); ?></th>
